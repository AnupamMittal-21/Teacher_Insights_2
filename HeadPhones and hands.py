...
# Hand-raise and Earphones Detection through Face Detection
...
if __name__ == "__main__":
    # Run the hand-raise and earphones detection through face detection
    detect_handraise_earphones_face()